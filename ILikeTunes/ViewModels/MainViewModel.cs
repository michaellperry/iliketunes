...
namespace ILikeTunes.ViewModels
{
    public class MainViewModel
    {
        ...
        public ICommand LikeTune
        {
            get
            {
                return MakeCommand
                    .Do(delegate
                    {
                        Tune tune = _community.AddFact(new Tune(TuneName));
                        _community.AddFact(new Like(_individual, tune));
                        TuneName = null;
                    });
            }
        }
        ...
        public ICommand DislikeTune
        {
            ...
            {
                return MakeCommand
                    .When(() => _selectedTune.Value != null)
                    .Do(delegate
                    {
                        Like like = _community.FindFact(
                            new Like(_individual, _selectedTune.Value));
                        _community.AddFact(new Dislike(like));
                    });
            }
        }
